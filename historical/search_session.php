...
$query = "SELECT id, title FROM movie WHERE title LIKE '%$movie%' LIMIT $debut, $elem_par_page";
$total = "SELECT COUNT(*) FROM movie WHERE title LIKE '%$movie%'";
$error = null;
try {
