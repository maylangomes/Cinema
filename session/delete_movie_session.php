...
$query = "DELETE FROM movie_schedule WHERE id_movie=$id_movie AND id_room=$id_room AND date_begin='$dateTime'";
$error = null;
try {
    ...
    if(empty($tab_verif)) {
        echo "This session dosn't exist or she had already been deleted !";
        return;
    }
